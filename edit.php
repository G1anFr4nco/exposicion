...
if($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $sql = "SELECT * FROM exposicion WHERE id=$id";
    ...
    do{
        if ( empty($id) || empty($nombre) || empty($email) || empty($celular) || empty($direccion) ){
            $errorMessage = "Todos los campos requeridos";
            break;
        }

        $sql = "UPDATE exposicion " . 
                "SET nombre = '$nombre', email = '$email', celular = '$celular', direccion = '$direccion'" .
                "WHERE id = $id";
